...
class Operator {
 ...
 public:
  /*Construct a general operator with specified index.
    Default constructor use the value generated by getMinValue().*/
  Operator() : index(getMinValue()) {}
  ...
  virtual IndexType getMinValue() const = 0;
...
class LadderOp : public Operator<IndexType> {
 ...
 public:
  /*Construct a ladder operator with specified index and creatorF.
    Default constructor use getMinValue() and false.*/
  LadderOp() : Operator<IndexType>(), creatorF(false) {}
  LadderOp(IndexType index, bool creatorF) : Operator<IndexType>(index), creatorF(creatorF) {}
...
class SpinOp : public Operator<IndexType> {
 ...
 public:
  ...
  SpinOp(IndexType index, bool isPlus) : Operator<IndexType>(index), isZ(false), isPlus(isPlus) {}
  SpinOp(IndexType index, bool isZ, bool isPlus) : Operator<IndexType>(index), isZ(isZ), isPlus(isPlus) {}
  SpinOp(SpinOp const & rhs) : Operator<IndexType>(rhs), isZ(rhs.isZ), isPlus(rhs.isPlus) {}
  ~SpinOp() {}
  /*Get information of the ladder operator.*/
